...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public void updateMobileNumber(String oldMobileNumber, String newMobileNumber) {
        Customer customer = customerRepository.findByMobileNumberAndActiveSw(oldMobileNumber, true)
                .orElseThrow(() -> new ResourceNotFoundException("Customer", "mobileNumber", oldMobileNumber));
