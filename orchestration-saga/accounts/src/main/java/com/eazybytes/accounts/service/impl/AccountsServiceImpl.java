...
public class AccountsServiceImpl  implements IAccountsService {
    ...
    public void updateMobileNumber(String oldMobileNumber, String newMobileNumber) {
        Accounts account = accountsRepository.findByMobileNumberAndActiveSw(oldMobileNumber, AccountsConstants.ACTIVE_SW)
                .orElseThrow(() -> new ResourceNotFoundException("Account", "mobileNumber", oldMobileNumber));
