...
public class LoansServiceImpl implements ILoansService {
     ...
     */
    @Override
    public void updateLoan(LoanUpdatedEvent loanUpdatedEvent) {
     ...
     */
    @Override
    public void deleteLoan(LoanDeletedEvent loanDeletedEvent) {
    ...
    @Override
    public void updateMobileNumber(String oldMobileNumber, String newMobileNumber) {
        Loans loans = loansRepository.findByMobileNumberAndActiveSw(oldMobileNumber, LoansConstants.ACTIVE_SW)
