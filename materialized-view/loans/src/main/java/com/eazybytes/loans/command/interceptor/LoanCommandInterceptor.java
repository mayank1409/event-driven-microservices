    ...
    public BiFunction<Integer, CommandMessage<?>, CommandMessage<?>> handle(@Nonnull List<? extends
        ...
        return (index, command) -> {
            if (CreateLoanCommand.class.equals(command.getPayloadType())) {
                ...
                loansRepository.findByMobileNumberAndActiveSw(updateLoanCommand.getMobileNumber(), true)
                ...
                loansRepository.findByLoanNumberAndActiveSw(deleteLoanCommand.getLoanNumber(), LoansConstants.ACTIVE_SW)
