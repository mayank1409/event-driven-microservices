...
public class LoanAggregate {
    ...
    public LoanAggregate(CreateLoanCommand createCommand) {
        ...
        AggregateLifecycle.apply(loanCreatedEvent).andThen(() -> AggregateLifecycle.apply(loanDataChangedEvent));
    }
    ...
    public void handle(UpdateLoanCommand updateCommand) {
        ...
        LoanDataChangedEvent loanDataChangedEvent = new LoanDataChangedEvent();
        BeanUtils.copyProperties(loanUpdatedEvent, loanDataChangedEvent);
        AggregateLifecycle.apply(loanUpdatedEvent).andThen(() -> AggregateLifecycle.apply(loanDataChangedEvent));
    }
