...
public class CardAggregate {
    ...
    public CardAggregate(CreateCardCommand createCommand) {
        ...
        AggregateLifecycle.apply(cardCreatedEvent).andThen(() -> AggregateLifecycle.apply(cardDataChangedEvent));
    }
    ...
    public void handle(UpdateCardCommand updateCommand) {
        ...
        AggregateLifecycle.apply(cardUpdatedEvent).andThen(() -> AggregateLifecycle.apply(cardDataChangedEvent));
    }
