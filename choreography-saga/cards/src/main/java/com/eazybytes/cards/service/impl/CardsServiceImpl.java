...
public class CardsServiceImpl implements ICardsService {
    ...
    public void updateMobileNumber(MobileNumberUpdateDto mobileNumberUpdateDto) {
        try {
            ...
            Cards cards = cardsRepository.findByMobileNumberAndActiveSw(currentMobileNum, true)
                    .orElseThrow(() -> new ResourceNotFoundException("Customer", "mobileNumber", currentMobileNum));
    ...
    @Override
    public void rollbackMobileNumber(MobileNumberUpdateDto mobileNumberUpdateDto) {
        String newMobileNumber = mobileNumberUpdateDto.getNewMobileNumber();
        Cards cards = cardsRepository.findByMobileNumberAndActiveSw(newMobileNumber, true)
